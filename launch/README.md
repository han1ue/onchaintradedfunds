...
4. Configure Redis Cloud with `REDIS_URL` and configure Cloudflare Turnstile. Production writes fail closed when launch data, rate limiting, or X checks are unavailable.
