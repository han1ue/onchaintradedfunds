...
describe("X post templates", () => {
  ...
  it("distinguishes a vote from a submission", () => {
    expect(buildVotePost("This deserves to launch because the theme is coherent.", proposal, "https://launch.example")).toBe("This deserves to launch because the theme is coherent.\n\nI just voted for AI Infrastructure OTF in OTF Launch\nhttps://launch.example/otfs/ai-infrastructure-otf");
  });
