export const errorMessages: Record<string, string> = {
  ...
  X_RECONNECT_REQUIRED: "Reconnect X so OTF Launch can refresh your eligibility.",
  X_POST_NOT_FOUND: "That public X post could not be found. Check the URL and try again.",
  PROOF_AUTHOR_MISMATCH: "This post was not published by your connected X account.",
