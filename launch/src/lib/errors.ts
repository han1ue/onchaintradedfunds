export const errorMessages: Record<string, string> = {
  ...
  PRICING_CONFIG_INVALID: "Choose a supported, complete price source for every unverified asset.",
  ...
  ASSET_METADATA_INVALID: "One or more assets have invalid metadata. Choose the asset again and retry.",
  ...
  PROPOSAL_ASSET_MINIMUM: "Choose at least two distinct assets for the portfolio.",
  PROPOSAL_WEIGHT_MINIMUM: "Allocate at least 1% to every asset.",
  PROPOSAL_WEIGHT_TOTAL: "Portfolio weights must total 100%.",
  PROPOSAL_NAME_INVALID: "Use a name between 5 and 80 characters that ends in “OTF”.",
  PROPOSAL_TICKER_INVALID: "Use an uppercase ticker of 1–16 letters, numbers, or hyphens.",
  PROPOSAL_THESIS_INVALID: "Add an investment thesis no longer than 2,048 bytes.",
  INVALID_PROPOSAL: "Review the proposal fields and portfolio allocations, then try again.",
  X_RECONNECT_REQUIRED: "Sign in with X again so OTF Launch can confirm your X identity.",
  ...
  PROPOSAL_LIMIT_REACHED: "You have reached the 10 confirmed OTF proposals allowed in this competition. Delete one before confirming another.",
