...
describe("competition phases", () => {
  ...
  it("represents the active six-hour interval without pre-filling a whole day", () => {
    ...
    expect(getCompetitionTiming(competition, new Date("2026-08-01T00:00:00.001Z")).progressDays).toBe(0.25);
    expect(getCompetitionTiming(competition, new Date("2026-08-01T05:59:59.999Z")).progressDays).toBe(0.25);
    ...
    expect(getCompetitionTiming(competition, new Date("2026-08-01T06:00:00.001Z")).progressDays).toBe(0.5);
    expect(getCompetitionTiming(competition, new Date("2026-08-01T11:59:59.999Z")).progressDays).toBe(0.5);
