...
function initialRow(asset: EligibleAsset | undefined, weight: string): Row {
  return {
    assetId: asset?.id ?? "",
    assetMetadata: null,
    pricingConfig: asset && asset.quality !== "high" ? preferredPricingConfig(asset.pricingConfigs) : null,
    weight,
  };
}
