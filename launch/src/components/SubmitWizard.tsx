...
export function SubmitWizard({ competition, assets, eligibility, turnstileSiteKey, siteUrl }: {
  ...
  </SectionCard><aside><SectionCard className="sideNote"><strong>Before you create an OTF</strong><ul><li>Use a verified, public X account with at least {eligibility.minFollowers.toLocaleString()} followers.</li><li>One OTF proposal per X account.</li><li>Choose at least two 18-decimal assets.</li><li>Verified assets already include an approved price source.</li><li>Unlisted assets require a qualifying Uniswap V3 pool.</li><li>Weights must total exactly 100%.</li><li>Created proposals cannot be edited.</li></ul></SectionCard></aside></div>;
}
