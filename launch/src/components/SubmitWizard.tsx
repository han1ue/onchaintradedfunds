...
export function SubmitWizard({ competition, assets, eligibility, turnstileSiteKey, siteUrl }: {
  ...
  </SectionCard><aside><SectionCard className="sideNote"><strong>Before you create an OTF</strong><ul><li>Use a verified, public X account with at least {eligibility.minFollowers.toLocaleString()} followers.</li><li>You can submit as many OTF proposals as you want.</li><li>Choose at least two 18-decimal assets.</li><li>Verified assets already include an approved saved price source.</li><li>Unlisted assets require a canonical Uniswap V3 pool plus passing liquidity, verified market-cap, age, GT, honeypot, and locked-liquidity evidence.</li><li>Weights must total exactly 100%.</li><li>You can delete a submission while it has 0 votes.</li></ul></SectionCard></aside></div>;
}
