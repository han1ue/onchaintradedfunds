...
export function VotePanel({
  ...
  return <SectionCard className="votePanel"><div className="cardHeading"><div><span>Your votes</span><small>{availability.votingOpen ? `${availableVotes} available · ${availability.unlockedVotes} unlocked` : "Voting begins after the submission week"}</small></div><Vote size={19} /></div><div className="panelBody ballotCta">
