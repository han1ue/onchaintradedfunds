...
export function OTFTokenSurface({ swap }: { swap: ReactNode }) {
  ...
  return <div className="appView tokenView tokenMarketView">
    <header className="tokenMarketHeader"><div className="tokenMarketIdentity"><OtfTokenIcon className="tokenMarketTokenIcon" size={44} /><div><h1>$OTF</h1><p>Trade the canonical pool and inspect price, market cap, launch lifecycle, buybacks, and fee allocation.</p></div></div><a className="secondaryAction" href={DOCS_URL} target="_blank" rel="noreferrer"><ReceiptText size={14} />Docs<ExternalLink size={12} /></a></header>
