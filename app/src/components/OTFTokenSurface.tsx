...
export function OTFTokenSurface({ swap }: { swap: ReactNode }) {
  ...
  const phases = [
    { title: "Not initialized", copy: ["Exact 15 ETH launch reference valuation.", "Initialization deposits 150 million OTF."] },
    { title: "Bootstrap active", copy: ["15 ETH to 135 ETH reference valuation.", "The launch router partially fills an order at either bootstrap boundary and leaves unused input with the buyer."] },
