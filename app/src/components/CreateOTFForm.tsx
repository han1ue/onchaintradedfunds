        ...
        <div className="sectionBody">
          ...
          {step === 3 ? (
            <div className="formSection reviewSection">
              ...
              <p className="createBlocked">No constituent tokens are transferred during creation. With zero supply, any depositor may mint at least 1 OTF—or multiple OTFs—by supplying the ceiling-scaled bootstrap basket.</p>
              {!deploymentReady && !creationLocked ? <div className="validationSummary"><CircleAlert size={15} /><div><strong>Creation deployment unavailable</strong><span>The schema-11 factory is not configured on this network. Review remains available, but submission is disabled.</span></div></div> : null}
