...
- `assets/otf-favicon.png` is a 64px transparent PNG export for external tools and integrations.

Applications may wrap the shared marks with their own navigation behavior, but must not duplicate their drawing, typography, or geometry.
