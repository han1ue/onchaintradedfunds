...
description: Architecture, formation, accounting, routing, and application disclosures.
---
...
Normative requirements are in the [protocol security specification](/protocol-security-spec).
Threats, trust assumptions, and unresolved production work are in [Security and risk](/security).
The token and fee policy is in [Token and fee incentives](/token-and-fee-incentives).
...
LP utility). The Docs control opens this documentation site externally. Wallet, quote,
...
docs/                 Nextra website and protocol documentation
docs/content/         Protocol, security, and incentive source documents
```
